...
유저 활성화를 위한 서비스
# 기능 소개
#### [0. 로그인해야 가능한 기능과 아닌 기능 구분](#0-로그인해야-가능한-기능과-아닌-기능)
#### [1. 판매할 중고 상품 등록 및 수정, 삭제(이미지 여러장 등록, 카카오 위치 API)](#1-판매할-중고-상품-등록-및-수정-삭제이미지-여러장-등록-카카오-위치-API로-주소)
#### [2. 최신 순으로 업데이트된 유저들의 거래 목록(검색)](#2-최신-순으로-업데이트된-유저들의-거래-목록검색-기능)
#### [3. 중고 상품 글 자세히 보기](#3-중고-상품-글-자세히-보기이미지-슬라이드-판매-상태-변경-좋아요-기능)
#### [4. 거래를 희망하는 유저들간의 1:1 채팅(Stomp websocket, Redis)](#4-거래를-희망하는-유저들간의-1-1-채팅stomp-websocket-redis-시스템)
#### [5. 웹 서비스 운영을 위한 관리자와 유저들을 위한 편의 서비스](#5-웹-서비스-운영을-위한-관리자와-유저들을-위한-편의-서비스)
#### 6. 지도 API를 이용한 검색(추정)
#### 7. 유저들 간의 자유 커뮤니케이션(추정)
#### 8. (희망)파이썬을 이용한 인공지능 기능
# 기능 구현
#### 0. 로그인해야 가능한 기능과 아닌 기능
  - SpringSecurity 설정
...
#### 1. 판매할 중고 상품 등록 및 수정, 삭제(이미지 여러장 등록, 카카오 위치 API로 주소)
  ##### 1-1. 중고 상품 글
  - 등록 및 수정
   > sell.js 일부
   ```java
...
#### 2. 최신 순으로 업데이트된 유저들의 거래 목록(검색 기능)
...
#### 3. 중고 상품 글 자세히 보기(이미지 슬라이드, 판매 상태 변경, 좋아요 기능)
  ##### 3-1. 이미지 슬라이드 기능
...
#### 4. 거래를 희망하는 유저들간의 1:1 채팅(Stomp websocket, Redis) 시스템
  - 채팅 설정
